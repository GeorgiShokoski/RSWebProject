...
namespace eSportsApp.Controllers
{
    ...
    public class PlayerController : ControllerBase
    {
        ...
        {
            string query = @"insert into dbo.Player(Name,Surname,Rating,Age,Country,Team) values ('" + player.Name + @"'
                                                                                        ,'" + player.Surname + @"'
                                                                                        ,'" + player.Rating + @"'
                                                                                        ,'"+ player.Age +@"'
                                                                                        ,'"+player.Country +@"'
        ...
        {
            string query = @"select Name from dbo.Team";
